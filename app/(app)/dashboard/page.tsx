  ...
  return (
    <>
      <div className="mb-6 flex flex-wrap gap-3">
        <Link href="/user" className="inline-flex rounded-full border border-border-strong px-4 py-2 text-sm font-semibold text-text-body">
          Open User Panel
        </Link>
        {isAdmin ? (
      ...
      {orders.data.length > 0 ? (
        <section className="mb-6 rounded-xl border border-border-default bg-surface-base p-5">
          ...
          return (
            <article key={itinerary.id} className="rounded-xl border border-border-default p-5">
              ...
              <Link
                ...
                className="inline-flex items-center rounded-full border border-border-strong px-4 py-2 text-sm font-semibold text-text-body"
              >
                Open itinerary
              </Link>
            </article>
