    ...
    <PageScaffold title="User Panel" description="Your account, saved itineraries, and booking activity.">
      ...
      <section className="mb-8 rounded-xl border border-border-default bg-surface-base p-5">
        ...
        {itineraries.data.length === 0 ? (
          <p className="text-sm text-text-body">No itineraries saved yet.</p>
        ) : (
      ...
      <section className="rounded-xl border border-border-default bg-surface-base p-5">
        <h2 className="mb-4 text-lg font-semibold">Recent Orders</h2>
        {orders.data.length === 0 ? (
          <p className="text-sm text-text-body">No orders found.</p>
        ) : (
          <div className="space-y-3">
