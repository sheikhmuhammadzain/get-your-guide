          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
             ...
             <div>
                ...
                <ul className="space-y-2 text-gray-400">
                   ...
                   <li><a href="#" className="hover:text-white transition-colors">Legal Information</a></li>
             ...
             <div>
                ...
                <ul className="space-y-2 text-gray-400">
                   <li><a href="#" className="hover:text-white transition-colors">As a Supply Partner</a></li>
                   <li><a href="#" className="hover:text-white transition-colors">As a Content Creator</a></li>
                   <li><a href="#" className="hover:text-white transition-colors">As an Affiliate Partner</a></li>
                </ul>
             </div>
